# title: "Calculate correlations across 3-factors and other vars -- using factor scores"
...
pfcs_fscores <- read_table("fscores_pfcs.dat", col_names = F)

# create dataframe with PFC-S fscores and validation vars
pfcs_fscores <- pfcs_fscores %>% dplyr::select(., X23, X25, X27) %>%
  rename(pfc_f1 = X23, pfc_f2 = X25, pfc_f3 = X27)
corr_vars <- corr_vars %>% dplyr::select(., -contains("factor"))
corr_vars <- cbind(corr_vars, pfcs_fscores)

# review missingness of vars for corr matrix
png("C:/Users/forev/Documents/NicolasCamacho/pfc_fa/paper/updated_process/visuals/corr_vars_missing_data_fscores.png",
...
ggsave(last_plot(), 
       filename = "C:/Users/forev/Documents/NicolasCamacho/pfc_fa/paper/updated_process/visuals/corr_vars_distrib_fscores.png")
...
ggcorrplot(corr_matrix$r, type = "lower", method = "square", 
  ...
  coord_fixed()
ggsave(last_plot(), 
       filename = "C:/Users/forev/Documents/NicolasCamacho/pfc_fa/paper/updated_process/visuals/corr_matrix_validity_fscores.png")
...
apa.cor.table(corr_vars_only, show.sig.stars = T,
              filename = "C:/Users/forev/Documents/NicolasCamacho/pfc_fa/paper/updated_process/visuals/corr_plot_apa_fscores.doc")
